        ...
        <div className="container">
          ...
          <div className="row">
            ...
            <ol>
              ...
              <li>Способность работать с нестандартными изделиями и предоставление дополнительных инструментов для их производства. Это дает нам преимущество в выполнении заказов, которые требуют особых операций.</li>
      ...
      <div className="section project">
        <div className="container">
          <div className="row">
            ...
            <div className="text">
              <p>Наша компания производит широкий спектр изделий, выполняя различные виды металлообработки. Мы специализируемся на изготовлении разнообразных изделий, включая самые сложные.</p>
        ...
        <div className="container">
          <div className="row">
            ...
            <div>
              ...
              <p>Устройства с ЧПУ подразделяются на несколько типов: карусельные, винторезные, цилиндрические и конические.</p>
              <ol>
