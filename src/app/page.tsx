        ...
        <div className="container">
          ...
          <div className="row">
            ...
            <ol>
              ...
              <li>Использование разных режущих пластин и качественных оправок дает нам возможность производить операции типа шлифовки или накатки. Это позволяет нам достичь высокого результата в финишной обработке изделий.</li>
        ...
        <div className="container">
          <div className="row">
            ...
            <div className="text">
              ...
              <p>Все наши изделия производятся с использованием передовых технологий металлообработки, что гарантирует высокое качество и надежность каждого изделия. Мы готовы удовлетворить потребности клиентов в различных отраслях промышленности и предложить решения, соответствующие их требованиям.</p>
            </div>
          </div>
        </div>
      </div>
        ...
        <div className="container">
          <div className="row">
            ...
            <div className="text">
              ...
              <p>Расчет стоимости производим быстро, сразе после получения всех материалов (описание работы, чертежи, эскизы). С момента получения, в течение дня Вам перезвонит наш менеджер, отправит коммерческое предложение и согласует все условия.</p>
              <table>
                <tbody>
                  <tr>
              ...
              <div className="order">
                ...
                >Заказать токарную обработку металла</a>
              </div>
            </div>
          </div>
        </div>
