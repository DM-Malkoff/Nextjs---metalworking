      ...
      <div className="section project">
        <div className="container">
          <div className="row">
            ...
            <div className="text">
              <p>Точение на токарном ЧПУ станке является одним из наиболее универсальных методов обработки материалов. Этот вид токарной работы требуется в самых разных ситуациях, когда возникает необходимость в создании или модернизации металлоизделий.</p>
              <p>Например, если сломалась деталь, и нет возможности купить новую, либо она больше не производится или стоит дорого, то на токарном станке можно изготовить новую. Если есть заготовка, то ее можно расточить или подточить под нужные размеры и форму.</p>
