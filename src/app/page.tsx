        ...
        <div className="container">
          <div className="row">
            ...
            <div className="text">
              ...
              <p>Расчет стоимости производим быстро, сразе после получения всех материалов (описание работы, чертежи, эскизы). С момента получения, в течение часа Вам перезвонит наш менеджер, отправит коммерческое предложение и согласует все условия.</p>
              <table>
                <tbody>
                  <tr>
